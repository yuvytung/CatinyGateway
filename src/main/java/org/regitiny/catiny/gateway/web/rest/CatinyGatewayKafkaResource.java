...
@RestController
@RequestMapping("/api/catiny-gateway-kafka")
public class CatinyGatewayKafkaResource
{

  private final Logger log = LoggerFactory.getLogger(CatinyGatewayKafkaResource.class);

  private final KafkaProperties kafkaProperties;
  private KafkaProducer<String, String> producer;
  private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

  public CatinyGatewayKafkaResource(KafkaProperties kafkaProperties)
  {
